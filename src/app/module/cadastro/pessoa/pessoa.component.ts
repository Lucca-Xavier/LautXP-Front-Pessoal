...
import { FormValidators } from 'src/app/shared/Validators/FormValidator';
...
export class PessoaComponent implements OnInit {
  ...
  formContato = new FormGroup({
    telefoneCelular: new FormControl<string>('', [Validators.required, FormValidators.celularValido]),
